...
/******QUEST SYTEM*******/
void intif_request_questlog(struct s_map_session_data * sd);
int intif_quest_save(struct s_map_session_data * sd);
...
int intif_achievement_reward(struct map_session_data *sd, s_achievement_db *adb);
