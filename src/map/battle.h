...
struct s_Damage {
	...
	int miscflag;
	enum e_damage_lv dmg_lv; /// ATK_LUCKY,ATK_FLEE,ATK_DEF
...
int battle_calc_cardfix(int attack_type, struct s_block_list *src, struct s_block_list *target, int nk, int s_ele, int s_ele_, int64 damage, int left, int flag);
