...
int inter_guild_parse_frommap(int fd)
{
	...
	{
	case 0x3030:
		mapif_parse_CreateGuild(fd, RFIFOL(fd, 4), RFIFOCP(fd, 8), (struct s_guild_member*)RFIFOP(fd, 32));
		break;
	...
	case 0x3032:
		mapif_parse_GuildAddMember(fd, RFIFOL(fd, 4), (struct s_guild_member*)RFIFOP(fd, 8));
		break;
	...
	case 0x303B:
		mapif_parse_GuildPosition(fd, RFIFOL(fd, 4), RFIFOL(fd, 8), (struct s_guild_position*)RFIFOP(fd, 12));
		break;
