...
extern "C" {
	...
	void chlogif_pincode_start(int fd, s_char_session_data* sd);
#endif
	...
	void chlogif_send_reqaccdata(int fd, s_char_session_data *sd);
	...
	int chlogif_parse_ackconnect(int fd, s_char_session_data* sd);
	int chlogif_parse_ackaccreq(int fd, s_char_session_data* sd);
	int chlogif_parse_reqaccdata(int fd, s_char_session_data* sd);
	int chlogif_parse_keepalive(int fd, s_char_session_data* sd);
	void chlogif_parse_change_sex_sub(int sex, int acc, int char_id, int class_, int guild_id);
	int chlogif_parse_ackchangesex(int fd, s_char_session_data* sd);
	int chlogif_parse_ackchangecharsex(int char_id, int sex);
	int chlogif_parse_ack_global_accreg(int fd, s_char_session_data* sd);
	int chlogif_parse_accbannotification(int fd, s_char_session_data* sd);
	int chlogif_parse_askkick(int fd, s_char_session_data* sd);
	int chlogif_parse_updip(int fd, s_char_session_data* sd);
